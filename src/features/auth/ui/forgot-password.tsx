            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="pointer-events-none absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[#737688]" />
                  <input
                    id="reset-email"
                    type="email"
                    value={email}
                    ...
                    required
                    className="w-full rounded-xl border border-[#e5e5e5] bg-white py-3.5 pl-11 pr-4 text-sm transition-all placeholder:text-[#737688] focus:border-[#0d0d0d] focus:outline-none"
                  />
                </div>
              </div>
